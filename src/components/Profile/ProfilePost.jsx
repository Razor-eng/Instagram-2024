	...
	return (
		<>
			...
			>
				...
				>
					<Flex _light={{ color: "white" }} alignItems={"center"} justifyContent={"center"} gap={50}>
						<Flex>
							<AiFillHeart size={20} />
			...
			<Modal isOpen={isModalOpen} onClose={onModalClose} isCentered={true} size={{ base: "3xl", md: "5xl" }}>
				<ModalOverlay />
				<ModalContent>
					<ModalCloseButton />
					<ModalBody bg={"#121212"} _light={{ bg: "gray.300" }} pb={5}>
						...
						>
							...
							<Flex flex={1} flexDir={"column"} px={10} display={{ base: "none", md: "flex" }}>
								...
								<Divider my={4} bg={"gray.500"} _light={{ borderColor: "gray.600" }} />
