...
import { SearchLogo, SearchLogoDark } from "../../assets/constants";
		...
		<>
			...
			>
				<Flex
					...
					onClick={onOpen}
				>
					{colorMode === "dark" ? <SearchLogo /> : <SearchLogoDark />}
					...
					<ModalBody pb={6}>
						<form onSubmit={handleSearchUser}>
							<FormControl>
								...
								<Input placeholder='Username' ref={searchRef} _light={{ borderColor: "gray" }} />
							</FormControl>
